			...
			<main>
				...
				<section id="mainContent" class="content">						
					...
					<div class="img-container">
						<img src="http://placehold.it/250x450" class="content-image" id="img-1-<?php echo $cod_pagina; ?>"/>
						<img src="http://placehold.it/250x450" class="content-image" id="img-2-<?php echo $cod_pagina; ?>"/>
					<div>
				</section>
