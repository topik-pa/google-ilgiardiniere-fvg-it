...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
	...
	<body class="giardiniere_privati">	
		...
		<div id="container">
			...
			<div id="mainContent">						
				...
				<p class="p1">
				<span>Un mestiere, seppur per certi aspetti soggettivo, non si inventa! <br />Eseguire una potatura di un albero non &egrave; facile perch&egrave; &quot;<em>lo si &egrave; letto</em>&quot; o perch&egrave; &quot;<em>&egrave; sempre stato fatto cos&igrave;</em>&quot;. <br />Il mestiere di giardiniere &egrave; la somma di conoscenza tecnica delle piante e professionalit&agrave;. Solo in questo modo si pu&ograve; raggiungere l'obiettivo che ci si &egrave; prefissati.<br /><strong>Il lavoro deve essere eseguito con attrezzatura idonea e soprattutto con un attenzione particolare alla sicurezza di chi opera!</strong><br />Un bel manto erboso non se lo pu&ograve; ottenere riportando un poco di terra e gettando dei semi (magari i semi presi in offerta al centro commerciale). Per un prato bello e duraturo, bisogna conoscer al meglio le caratteristiche del terreno. Altri aspetti fondamentali sono il momento della semina, le concimazioni mirate e, ovviamente, la scelta pi&ugrave; appropriata della semenza, che varia a seconda di ogni situazione.
				</span>
				</p>
				...
				<ul> 
					...
					<li>Creazione e manutenzione aiuole con fornitura piante</li>
					...
					<li>Scavi in spazi ristretti</li>
					<li>Manutenzioni di aree boschive e zone incolte</li>
					<li>Bonifica terreni</li>
					<li>Fresatura ceppaie</li>
